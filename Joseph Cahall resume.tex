...
\fancyhf{}
\fancyhead[c]{\centering{\renewcommand{\\}{\ {\large\textperiodcentered}\ }}{\Large\Letter} \href{mailto:jcahall@lawschool.gonzaga.edu} {jcahall@lawschool.gonzaga.edu} \ {\Large\Mobilefone} {(\texttt{+}1) 317.385.2343}} 

\fancyfoot[r]{\scriptsize{\textsuperscript{*}}\footnotesize{The \LaTeX\ source file for this resum\'{e} can be viewed in my \href{https://github.com/josephcahall/prof-docs/blob/master/Joseph%20Cahall%20resume.tex} {GitHub repository}.}}
